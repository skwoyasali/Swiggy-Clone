...
function Header(){
    return (
        <div>
            <nav className='flex justify-between border items-center px-12'>
                ...
                <ul className='flex'>
                    <div className='flex m-4'>
                        <span className='mt-5'><IoMdSearch /></span>
                        <li className='m-4'>Search</li>
                    </div>
                    <div className='flex m-4'>
                        <span className='mt-5'><BiSolidOffer /></span>
                        <li className='m-4'>Offer</li>
                    </div>
                    <div className='flex m-4'>
                        <span className='mt-5'><IoHelpBuoyOutline /></span>
                        <li className='m-4'>Help</li>
                    </div>
                    <div className='flex m-4'>
                        <span className='mt-5'><CgProfile /></span>
                        <li className='m-4'>Sign in</li>
                    </div>
                    <div className='flex m-4'>
                        <span className='mt-5'><IoCartOutline /></span>
